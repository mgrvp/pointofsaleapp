        ...
        <section>
            ...
            if (isset($_POST['ubah'])) {
                ...
                if ($queryUpdate === TRUE) {
                    ...
                    echo "<script> alert('Data Berhasil Diubah'); location.href='index.php?hal=master/barang/list' </script>";
                    exit;
                } else {
                    ...
                    <h4>POINT OF SALE</h4>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="blog-post bg-dark">
                                        ...
                                        <div class="media">
                                            <div class="panel-body bg-dark col-md-12">
                        ...
                        WHERE id_session='$id_session'";
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td>
                                                                    <a href="hapus_keranjang.php?hapus=<?= $data['id_keranjang'] ?>&id_session=<?= $data['id_session'] ?>"><i class="fa fa-times" style="color: red"></i></a>
                                                                </td>
                                                                <td>
                                                        ...
                                                        <tr>
                                                            <td colspan="6">
                                                                <div style="text-align: center">
                                                                    <button class="btn btn-success" type="submit" data-toggle="modal" data-target="#myModal">Bayar
                                                                    </button>
                                                                </div>
                                                            </td>

                                                            <div class="modal fade rounded" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                        ...
                                                                        <div class="modal-body row">
                                                                            <div class="col-sm-12 p-3 p-md-3">
                                                                                ...
                                                                                <form method="POST" action="cetak.php">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <input type="hidden" id="type1" name="grand_total" onKeyUp="kalkulatorTambah(getElementById('type1').value,this.value);" value="<?php echo number_format($total, 0, ',', '.'); ?>" />

                                                                                        <input type="text" class="form-control input-lg" placeholder="input payment" id="type2" name="cash" onKeyUp="kalkulatorTambah(getElementById('type1').value,this.value);" />
                                                                                    ...
                                                                                    <div class="pull-right">
                                                                                        ...
                                                                                        <button class="btn btn-info btn-sm" type="submit">SAVE / PRINT
                                                                                        </button>
                                                                                        <button class="btn btn-danger btn-sm" data-dismiss="modal" aria-hidden="true" type="button">
                                                                                            Cancel
                                                                                        </button>
                                                                                    </div>
                                                                                </form>
