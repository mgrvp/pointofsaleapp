                        ...
                        WHERE id_session='$id_session'";
                                        ...
                                        <tr>
                                            <td colspan="4" align="reight">
                                                ...
                                                <button class="btn btn-primary" type="submit" data-toggle="modal" data-target="#myModal"><i class="fa fa-shopping-cart"></i> Bayar
                                                </button>
                                            </td>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <form method="POST" action="cetak.php">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control input-lg" id="type2" name="cash" onKeyUp="kalkulatorTambah(getElementById('type1').value,this.value);" />
                                                                    ...
                                                                    <div class="pull-right">
                                                                        ...
                                                                        <button class="btn btn-primary btn-sm" type="submit"><i class="fa fa-check-square-o"></i> OK
                                                                        </button>
